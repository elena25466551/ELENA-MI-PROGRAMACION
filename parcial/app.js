...
ConexionBD();
require("dotenv").config();//permite utilizar variables de entorno
//permite utilizar rutas de carpetas independientemente de las barras
const path = require("path")
//para manejar la seguridad del servidor
const cors = require('cors');
//permite ver las peticiones del servidor en la terminal
